...
import { toggleArchiveNote, toggleTrashNote } from '@/service/notesServices';
...
export default function arsip() {
  ...
  // const handleBulkUnarchive = async (id: string) => {
  //   for (const id of selectedIds) {
      ...
      navigation.setOptions({
        ...
        headerRight: () => (
          <View style={{ flexDirection: "row", marginRight: 10 }}>
            ...
            <Pressable onPress={handleBulkUnarchive}>
              <Ionicons name="arrow-up-circle-outline" size={24} color="black" style={{ marginRight: 20 }} />
            </Pressable>
